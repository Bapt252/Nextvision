"""
🚀 Nextvision V3.0 - Scorers V3 Package (PROMPT 9)
Package des scorers révolutionnés avec Intelligence V3.0

Scorers opérationnels (7/12) :
...
- SectorCompatibilityScorer : Compatibilité secteur candidat-entreprise (6% poids) ✨ NEW

Author: NEXTEN Team
Version: 3.0.0 - Enhanced Intelligence + Sector Compatibility
"""
