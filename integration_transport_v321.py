#!/usr/bin/env python3
"""
🚗 NEXTVISION V3.2.1 - INTÉGRATION TRANSPORT INTELLIGENCE
========================================================
...
Author: NEXTEN Team
Version: 3.2.1 - Transport Intelligence Integration
"""
...
try:
    ...
    from nextvision.models.questionnaire_advanced import (
        ...
        TimingInfo, RaisonEcoute, EnvironnementTravail
    )
...
class TransportIntegratedMatchingEngine:
    ...
    def _create_candidate_questionnaire(
        ...
        """📋 Crée questionnaire candidat pour scoring"""
...
async def test_transport_integration():
    ...
    print("=" * 60)
    print("🧪 TEST INTÉGRATION TRANSPORT INTELLIGENCE V3.2.1")
    print("=" * 60)
    ...
    # Jobs test avec adresses réelles Paris
    test_jobs = [
        {
            "address": "1 Place Vendôme 75001 Paris",
            "raison_ecoute": "Poste trop loin de mon domicile"
        },
        {
    ...
    report_file = f"transport_integration_test_report_{timestamp}.json"
    
    report = {
        "test_metadata": {
            "timestamp": datetime.now().isoformat(),
            "version": "Nextvision V3.2.1 + Transport Intelligence",
    ...
    # Résumé final
    print("\n" + "=" * 60)
    print("📊 RÉSUMÉ INTÉGRATION TRANSPORT INTELLIGENCE")
    print("=" * 60)
...
def main():
    ...
    print("🚗 NEXTVISION V3.2.1 - INTÉGRATION TRANSPORT INTELLIGENCE")
    print("=" * 60)
    ...
    if not os.path.exists("main.py"):
        ...
        print("💡 Commande: cd /Users/baptistecomas/Nextvision/ && python integration_transport_v321.py")
        sys.exit(1)
