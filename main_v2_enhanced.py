"""
🎯 Nextvision - Main FastAPI Application v2.0 avec Matching Bidirectionnel + Enhanced Bridge
...
+ ENHANCED : Enhanced Bridge v2.0 avec Auto-Fix Intelligent

Author: NEXTEN Team
Version: 2.0.0 - Enhanced Bidirectional Matching Integration
"""
...
# === ENHANCED BRIDGE v2.0 IMPORTS ===
from nextvision.services.enhanced_commitment_bridge import (
    EnhancedCommitmentBridge, EnhancedBridgeFactory
)
from nextvision.api.v2.enhanced_endpoints import router_v2 as enhanced_router
...
# === ENHANCED BRIDGE v2.0 SERVICES ===
enhanced_bridge = EnhancedBridgeFactory.create_production_bridge()

app = FastAPI(
    title="🎯 Nextvision API v2.0 Enhanced",
    description="""
    **Algorithme de matching IA adaptatif pour NEXTEN + Google Maps Intelligence + Enhanced Bridge**
    ...
    * **Pondération adaptative** : Localisation boostée si \"Poste trop loin\"
    ...
    ## 🎯 NOUVEAUTÉ v2.0: Matching Bidirectionnel + Enhanced Bridge
    ...
    * **Enhanced Bridge v2.0 avec Auto-Fix Intelligence** :
      - **Enhanced Universal Parser v4.0** : CVs candidats avec auto-correction
      - **Système ChatGPT Enhanced** : Fiches de poste avec validation robuste
      - **Auto-fix intelligent** : Correction automatique erreurs de parsing
      - **Validation robuste** : Vérification et nettoyage données
      - **Formats spécifiques** : \"5 ans - 10 ans\", \"35K à 38K annuels\"
      - **Conservation badges** : \"Auto-rempli\" et métadonnées complètes
      - **Performance cache** : Optimisation temps de réponse
    ...
    * **Job Parser GPT Enhanced** : Réutilise l'infrastructure mature + auto-fix
    * **CV Parser GPT Enhanced** : Connexion directe + validation robuste
    * **Workflow complet Enhanced** : Parse → Auto-fix → Validate → Match en une requête
    * **Architecture optimale** : Aucune duplication de code + intelligence ajoutée
    
    ## 🚀 APIs Disponibles
    
    * **v1.0** : Matching unidirectionnel + Google Maps Intelligence
    * **v2.0 Standard** : Matching bidirectionnel + Intégration Commitment-
    * **v2.0 Enhanced** : Auto-fix + Validation + Performance optimisée
    * **Bridge Enhanced** : Conversion intelligente Enhanced Parser v4.0 + ChatGPT
    * **Batch Enhanced** : Traitement haute performance avec auto-fix (1000 profils)
    * **Analytics Enhanced** : Insights détaillés + métriques de qualité
    """,
...
# === INTÉGRATION ROUTERS BIDIRECTIONNELS + ENHANCED ===
...
@app.get("/", tags=["Root"])
async def root():
    """🏠 Root endpoint avec Enhanced Bridge v2.0"""
    return {
        "service": "Nextvision Enhanced",
        "description": "Algorithme de matching IA adaptatif pour NEXTEN + Google Maps Intelligence + Enhanced Bridge v2.0",
        "version": "2.0.0-Enhanced",
        "status": "active",
        "innovations": {
            ...
            "v2.0_ENHANCED": "Enhanced Bridge avec Auto-Fix Intelligence"
        },
        "frontend_integration": "https://github.com/Bapt252/Commitment-",
        "bridge_integration": "Commitment- → Nextvision Enhanced (Parser v4.0 + ChatGPT + Auto-Fix)",
        "docs": "/docs",
        "api_versions": {
            "v1": {
            ...
            "v2_enhanced": {
                ...
                "enhanced_stats": "/api/v2/conversion/commitment/enhanced/stats",
                "enhanced_config": "/api/v2/conversion/commitment/enhanced/config",
                "enhanced_cache_clear": "/api/v2/conversion/commitment/enhanced/cache"
            }
        },
        ...
        "enhanced_features": {
            "auto_fix_intelligence": "Correction automatique erreurs parsing",
            "robust_validation": "Vérification et nettoyage données",
            "performance_cache": "Optimisation temps de réponse",
            "retry_logic": "Tentatives multiples en cas d'échec",
            "batch_processing": "Traitement lot avec auto-fix",
            "quality_metrics": "Métriques détaillées de qualité"
        },
        "performance_targets": {
            ...
            "enhanced_conversion": "< 100ms",
            "batch_processing": "1000 combinations < 5s",
            "auto_fix_success_rate": "> 95%"
        }
    }

@app.get("/api/v1/health", tags=["Health"])
async def health_check():
    """❤️ Health Check avec statut Enhanced Bridge"""
    return {
        "status": "healthy",
        "service": "Nextvision Enhanced",
        "version": "2.0.0-Enhanced",
        ...
        "features": {
            ...
            "enhanced_bridge": True,        # NOUVEAU
            "auto_fix_intelligence": True,  # NOUVEAU
            "robust_validation": True,      # NOUVEAU
            "performance_caching": True     # NOUVEAU
        },
        "services_status": {
            "bidirectional_matcher": "active",
            "commitment_bridge": "active",
            "enhanced_bridge": "active",    # NOUVEAU
            "google_maps": "active",
            "transport_filtering": "active"
        },
        "enhanced_bridge_stats": enhanced_bridge.get_enhanced_stats()["enhanced_bridge_stats"]
    }
    ...
    try:
        ...
        response = {
            ...
            "metadata": {
                ...
                "upgrade_notices": {
                    "bidirectional": "Utilisez /api/v2/matching/bidirectional pour le matching bidirectionnel",
                    "enhanced": "Utilisez /api/v2/conversion/commitment/enhanced pour l'intégration Commitment- avec auto-fix"
                }
            }
        }
        ...
        logger.info(f"🔧 Suggestion: Migrer vers Enhanced Bridge v2.0")
...
async def integration_logging_middleware(request, call_next):
    """📝 Middleware pour logger toutes les requêtes Enhanced"""
    start_time = time.time()
    ...
    if request.url.path.startswith("/api/v1/integration/"):
        ...
        if "enhanced" in request.url.path:
            logger.info(f"🔧 {request.method} {request.url.path} - Enhanced Bridge v2.0")
        elif "bidirectional" in request.url.path or "conversion" in request.url.path:
...
if __name__ == "__main__":
    print("🎯 === NEXTVISION API v2.0 ENHANCED STARTUP ===")
    ...
    print("🎯 Matching Bidirectionnel ACTIF")
    print("🔧 NOUVEAUTÉ: Enhanced Bridge v2.0 avec Auto-Fix Intelligence")
    ...
    print("  • Enhanced Bridge: http://localhost:8000/api/v2/conversion/commitment/enhanced/stats")
    print("")
    ...
    print("")
    print("🎯 Matching Bidirectionnel v2.0:")
    ...
    print("")
    print("🔧 ENHANCED BRIDGE v2.0:")
    print("  • Auto-Fix Intelligence: RÉVOLUTIONNAIRE")
    print("  • Validation Robuste: ACTIVÉE")
    print("  • Performance Cache: OPTIMISÉ")
    print("  • Retry Logic: INTELLIGENT")
    print("  • Batch Enhanced: 1000 profils < 3s")
    print("  • Quality Metrics: DÉTAILLÉES")
    print("  • Configuration API: DYNAMIQUE")
    print("")
    print("🔗 Révolution NEXTEN: Bridge + IA + Géospatial + Bidirectionnel + Auto-Fix")
    print("================================================================================")
    
    uvicorn.run("main_v2_enhanced:app", host="0.0.0.0", port=8000, reload=True)
